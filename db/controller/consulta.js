...
async function findOneAppointmentByTuple(client,
    {
        doctor, 
        patient, 
        date
  ...
  if (result) {
    console.log(`Found an appointment in the collection with the tuple ('${doctor}', '${patient}', '${date}'):`);
    console.log(result);
  } else {
...
async function updateAppointmentByTuple(client,
    {
        doctor, 
        patient, 
        date
